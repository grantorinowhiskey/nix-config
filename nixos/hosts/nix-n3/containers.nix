...

{
  ...
  systemd.services."podman-radarr" = {
    ...
    after = [
      "podman-network-radarr_default.service"
    ];
    requires = [
      "podman-network-radarr_default.service"
    ];
  ...
  # Networks
  systemd.services."podman-network-radarr_default" = {
    path = [ pkgs.podman ];
    serviceConfig = {
      Type = "oneshot";
      RemainAfterExit = true;
      ExecStop = "podman network rm -f radarr_default";
    };
    script = ''
      podman network inspect radarr_default || podman network create radarr_default
    '';
