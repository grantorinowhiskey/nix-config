...

{
  ...
  systemd.services."podman-sonarr" = {
    ...
    after = [
      "podman-network-sonarr_default.service"
    ];
    requires = [
      "podman-network-sonarr_default.service"
    ];
  ...
  # Networks
  systemd.services."podman-network-sonarr_default" = {
    path = [ pkgs.podman ];
    serviceConfig = {
      Type = "oneshot";
      RemainAfterExit = true;
      ExecStop = "podman network rm -f sonarr_default";
    };
    script = ''
      podman network inspect sonarr_default || podman network create sonarr_default
    '';
